...
par(mfrow=c(3,1))
hist(log10(colSums(gexp)+1))
hist(log10(colSums(gexp/cell_area)+1))
hist(log10(colSums(gexp/nuc_area)+1))

gexp_lognorm <- log10(gexp/cell_area + 1)
...
saveRDS(spe, file = "outputs/xenium_humanBreastCancer_preprocessed.RDS")